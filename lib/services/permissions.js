...
export function isValid(permissions) {
  ...
  if (!isValidObject(permissions.user) || !isValidBoolean(permissions.user.create) || !isValidBoolean(permissions.user.delete) || !isValidBoolean(permissions.user.read) || !isValidBoolean(permissions.user.update)) {
    return false;
  }
