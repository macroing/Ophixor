  ...
  return {
    ...
    editor: {
      ...
      roleGroupOrder: {
        ...
        layout: ["Size", "Spacing"],
        selectors: ["Selectors"],
        styling: ["Surface", "Border", "Typography", "Focus State", "Theme"],
      },
...
`;
      ...
      .select.select-danger:focus-visible {
        border-color: var(--pc-semantic-status-danger);
        box-shadow: var(--pc-semantic-focus-ring-danger);
      }

      .select.select-success:focus-visible {
        border-color: var(--pc-semantic-status-success);
        box-shadow: var(--pc-semantic-focus-ring-success);
      }

      .select.select-warning:focus-visible {
        border-color: var(--pc-semantic-status-warning);
        box-shadow: var(--pc-semantic-focus-ring-warning);
      }
      ...
      .select.select-danger:read-only {
        border-color: var(--pc-semantic-status-danger);
        box-shadow: none;
        outline: none;
      }

      .select.select-success:read-only {
        border-color: var(--pc-semantic-status-success);
        box-shadow: none;
        outline: none;
      }

      .select.select-warning:read-only {
        border-color: var(--pc-semantic-status-warning);
        box-shadow: none;
        outline: none;
      }
`;
    ...
    exportHTML: (select, selectSchema, pageSchema, indentation) => {
      ...
      return `${indentation}<select class="select ${select?.id}${select?.props?.theme === "danger" ? " select-danger" : select?.props?.theme === "success" ? " select-success" : select?.props?.theme === "warning" ? " select-warning" : ""}"${disabled ? ` disabled="disabled"` : ""} data-pc-id="${select?.id || ""}"${select?.props?.id ? ` id="${select.props.id}"` : ""}${name ? ` name="${name}"` : ""} value="${select?.props?.value || ""}">${(select?.props?.options || []).map((option) => `\n${indentation + "  "}<option value="${option?.value || ""}">${option?.label || ""}</option>`).join("")}\n${indentation}</select>`;
    },
