...
export default function Rating({ componentId, editor, isVisible, onChange, readOnly, styles = importedStyles, value, ...styleProps }) {
  ...
  const safeReadOnly = typeof readOnly === "boolean" ? readOnly : Boolean(readOnly);
  ...
  function onMouseEnter(value) {
    setInternalValueHover(safeReadOnly ? 0 : value);
  }
