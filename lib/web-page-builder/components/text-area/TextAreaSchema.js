...
`;
      ...
      .text-area.text-area-danger:hover {
        border-color: var(--pc-semantic-status-danger);
      }

      .text-area.text-area-success:hover {
        border-color: var(--pc-semantic-status-success);
      }

      .text-area.text-area-warning:hover {
        border-color: var(--pc-semantic-status-warning);
      }
      ...
      .text-area.text-area-danger:focus {
        border-color: var(--pc-semantic-status-danger);
      }

      .text-area.text-area-success:focus {
        border-color: var(--pc-semantic-status-success);
      }

      .text-area.text-area-warning:focus {
        border-color: var(--pc-semantic-status-warning);
      }
      ...
      .text-area.text-area-danger:focus-visible {
        border-color: var(--pc-semantic-status-danger);
        box-shadow: var(--pc-semantic-focus-ring-danger);
      }

      .text-area.text-area-success:focus-visible {
        border-color: var(--pc-semantic-status-success);
        box-shadow: var(--pc-semantic-focus-ring-success);
      }

      .text-area.text-area-warning:focus-visible {
        border-color: var(--pc-semantic-status-warning);
      ...
      .text-area.text-area-danger:read-only {
        border-color: var(--pc-semantic-status-danger);
        box-shadow: none;
        outline: none;
      }

      .text-area.text-area-success:read-only {
        border-color: var(--pc-semantic-status-success);
        box-shadow: none;
        outline: none;
      }

      .text-area.text-area-warning:read-only {
        border-color: var(--pc-semantic-status-warning);
        box-shadow: none;
        outline: none;
      }
