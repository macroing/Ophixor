...
${form?.slots?.body || ""}${(form?.slots?.body || "").trim() === "" ? "\n" : ""}${indentation}</form>`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Button", "Checkbox", "Divider", "Element", "Heading", "Icon", "Input", "Label", "List", "ProgressBar", "Rating", "RichText", "RadioGroup", "Section", "Select", "Spacer", "Spinner", "Switch", "Table", "Text", "TextArea"],
      },
    },
  };
}
