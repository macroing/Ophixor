...
`;
      ...
      .form {
        ...
        flex-grow: var(--form-flex-grow);
        flex-shrink: var(--form-flex-shrink);
        gap: var(--form-gap);
...
${form?.slots?.body || ""}${(form?.slots?.body || "").trim() === "" ? "\n" : ""}${indentation}</form>`;
    ...
    props: {
      ...
      flexGrow: {
        ...
        cssVariableName: "--form-flex-grow",
        defaultValue: "0",
        label: "Flexbox grow",
        role: "layout",
        roleGroup: "Size",
      ...
      flexShrink: {
        ...
        cssVariableName: "--form-flex-shrink",
        defaultValue: "1",
    ...
    slots: {
      body: {
        allowedChildComponents: ["Button", "Checkbox", "Divider", "Element", "Heading", "Icon", "Input", "Label", "List", "Marquee", "ProgressBar", "Rating", "RichText", "RadioGroup", "Section", "Select", "Spacer", "Spinner", "Switch", "Table", "Text", "TextArea"],
      },
    },
  };
}
