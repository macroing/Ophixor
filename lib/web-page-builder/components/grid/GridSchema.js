...
${grid?.slots?.body || ""}${(grid?.slots?.body || "").trim() === "" ? "\n" : ""}${indentation}</div>`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Canvas", "Card", "Checkbox", "Dialog", "Divider", "Element", "Form", "Grid", "Heading", "Icon", "Image", "Input", "Label", "Link", "List", "Map", "Rating", "RichText", "RadioGroup", "Section", "Select", "Spacer", "Spinner", "Switch", "TabPane", "Table", "Text", "TextArea"],
      },
    },
  };
}
