  ...
  return {
    ...
    editor: {
      ...
      roleGroupOrder: {
        ...
        layout: ["Spacing"],
        selectors: ["Selectors"],
        styling: ["Structure", "Typography", "Size", "Weight", "Line Height", "Letter Spacing", "Surface", "Element"],
      },
...
`;
      ...
      .heading {
        ...
        overflow: var(--heading-overflow);
        text-align: var(--heading-text-align);
        text-overflow: var(--heading-text-overflow);
...
`;
    ...
    props: {
      ...
      overflow: {
        ...
        cssVariableName: "--heading-overflow",
      ...
      textOverflow: {
        ...
        cssVariableName: "--heading-text-overflow",
        defaultValue: "clip",
        label: "Text overflow",
        role: "styling",
        roleGroup: "Element",
    ...
    slots: {
      body: {
        allowedChildComponents: ["Badge", "Element", "Icon", "Link", "Text"],
      },
    },
  };
}
