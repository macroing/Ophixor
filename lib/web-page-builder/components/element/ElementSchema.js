...
${element?.slots?.body || ""}${(element?.slots?.body || "").trim() === "" ? "\n" : ""}${indentation}</${elementElement}>`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Card", "Checkbox", "Dialog", "Divider", "Element", "Footer", "Form", "Grid", "Heading", "Icon", "Image", "Input", "Label", "Link", "List", "ListItem", "Map", "MenuBar", "RadioGroup", "Rating", "RichText", "Section", "Select", "SideBar", "Spacer", "Spinner", "Switch", "TabPane", "Table", "TableData", "TableHeader", "TableRow", "Text", "TextArea"],
      },
    },
  };
}
