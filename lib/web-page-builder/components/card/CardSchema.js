...
`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Divider", "Grid", "Element", "Form", "Heading", "Icon", "Image", "Link", "List", "Map", "ProgressBar", "Rating", "RichText", "Section", "Spacer", "Spinner", "Table", "Text"],
      },
      footer: {
