...
`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Divider", "Grid", "Element", "Form", "Heading", "Image", "Link", "List", "Map", "RichText", "Section", "Spacer", "Spinner", "Table", "Text"],
      },
      footer: {
        allowedChildComponents: ["Alert", "Badge", "Button", "Element", "Spacer", "Spinner", "Text"],
      },
      header: {
        allowedChildComponents: ["Alert", "Badge", "Button", "Element", "Heading", "Image", "Spacer", "Spinner", "Text"],
      },
    },
    variants: [
      {
