...
`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Divider", "Grid", "Element", "Form", "Heading", "Icon", "Image", "Link", "List", "Map", "Marquee", "ProgressBar", "Rating", "RichText", "Section", "Spacer", "Spinner", "Table", "Text"],
      },
      footer: {
        allowedChildComponents: ["Alert", "Badge", "Button", "Element", "Icon", "ProgressBar", "Rating", "Spacer", "Spinner", "Text"],
      },
      header: {
        allowedChildComponents: ["Alert", "Badge", "Button", "Element", "Heading", "Icon", "Image", "ProgressBar", "Rating", "Spacer", "Spinner", "Text"],
      },
    },
    variants: [
      {
