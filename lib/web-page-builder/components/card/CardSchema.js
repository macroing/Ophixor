...
`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Divider", "Grid", "Element", "Form", "Heading", "Icon", "Image", "Link", "List", "Map", "RichText", "Section", "Spacer", "Spinner", "Table", "Text"],
      },
      footer: {
        allowedChildComponents: ["Alert", "Badge", "Button", "Element", "Icon", "Spacer", "Spinner", "Text"],
      },
      header: {
        allowedChildComponents: ["Alert", "Badge", "Button", "Element", "Heading", "Icon", "Image", "Spacer", "Spinner", "Text"],
      },
    },
    variants: [
      {
