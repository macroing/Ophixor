...
export default function Card({ children, componentId, customClassName, editor, element, isVisible, onClick, onSubmit, styles = importedStyles, ...styleProps }) {
  ...
  return (
    <CardElement className={classNames(styles.card, ...editorClasses, customClassName)} data-pc-id={componentId} onClick={safeOnClick} onSubmit={safeOnSubmit} style={style} {...editorProps}>
...
export function DarkCard({ children, isHoverEffect = false, ...rest }) {
  return (
    <Card {...createDarkCardProps(isHoverEffect)} {...rest}>
      {children}
    </Card>
  );
}
...
function createDarkCardProps(isHoverEffect = false) {
  return {
    backgroundColor: "#1f2937",
    backgroundColorBody: "#1f2937",
    backgroundColorBodyHover: isHoverEffect ? "#172554" : "#1f2937",
    backgroundColorFooter: "#1f2937",
    backgroundColorFooterHover: isHoverEffect ? "#172554" : "#1f2937",
    backgroundColorHeader: "#1f2937",
    backgroundColorHeaderHover: isHoverEffect ? "#172554" : "#1f2937",
    backgroundColorHover: isHoverEffect ? "#172554" : "#1f2937",
    borderColor: "#374151",
    borderColorHover: isHoverEffect ? "#1e3a8a" : "#374151",
    color: "#e5e7eb",
    colorHover: "#e5e7eb",
  };
}
