...
export function createTabPaneItemSchema() {
  return {
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Button", "Divider", "Grid", "Element", "Form", "Heading", "Icon", "Image", "Link", "List", "ProgressBar", "Rating", "RichText", "Section", "Spacer", "Spinner", "TabPane", "Table", "Text"],
      },
    },
  };
}
