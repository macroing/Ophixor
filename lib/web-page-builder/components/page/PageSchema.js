...
export function createPageSchema() {
  return {
    componentGroups: [
      ...
      {
        componentTypes: ["Heading", "Text", "RichText", "Image", "Badge", "List", "ListItem", "Table", "TableRow", "TableHeader", "TableData", "Icon", "Rating"],
        label: "Content",
      },
      {
...
${bodyHtml}      </div>
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Canvas", "Card", "Dialog", "Divider", "Element", "Footer", "Form", "Grid", "Map", "MenuBar", "Rating", "RichText", "Section", "SideBar", "Spacer", "Spinner", "TabPane", "Table"],
      },
    },
  };
}
