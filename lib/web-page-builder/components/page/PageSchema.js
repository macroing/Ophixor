...
export function createPageSchema() {
  return {
    componentGroups: [
      {
        componentTypes: ["Section", "Grid", "Card", "Divider", "Spacer", "MenuBar", "SideBar", "Footer", "Accordion", "AccordionItem", "TabPane", "TabPaneItem"],
        label: "Layout",
      },
      {
...
${bodyHtml}      </div>
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Canvas", "Card", "Dialog", "Divider", "Element", "Footer", "Form", "Grid", "Map", "MenuBar", "ProgressBar", "Rating", "RichText", "Section", "SideBar", "Spacer", "Spinner", "TabPane", "Table"],
      },
    },
  };
}
