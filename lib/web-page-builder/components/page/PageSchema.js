...
import { createAccordionItemSchema } from "../accordion-item/AccordionItemSchema";
import { createAccordionSchema } from "../accordion/AccordionSchema";
...
import { createIconSchema } from "../icon/IconSchema";
...
import { createMarqueeSchema } from "../marquee/MarqueeSchema";
import { createMenuBarSchema } from "../menu-bar/MenuBarSchema";
import { createProgressBarSchema } from "../progress-bar/ProgressBarSchema";
import { createRadioGroupSchema } from "../radio-group/RadioGroupSchema";
import { createRatingSchema } from "../rating/RatingSchema";
...
import { createTabPaneItemSchema } from "../tab-pane-item/TabPaneItemSchema";
import { createTabPaneSchema } from "../tab-pane/TabPaneSchema";
...
export function createPageSchema() {
  return {
    componentGroups: [
      {
        componentTypes: ["Section", "Grid", "Card", "Divider", "Spacer", "MenuBar", "SideBar", "Footer", "Accordion", "AccordionItem", "TabPane", "TabPaneItem", "Marquee"],
        label: "Layout",
      },
      {
        componentTypes: ["Heading", "Text", "RichText", "Image", "Badge", "List", "ListItem", "Table", "TableRow", "TableHeader", "TableData", "Icon", "Rating", "ProgressBar"],
        label: "Content",
      },
      {
    ...
    componentSchemas: {
      ...
      Map: createMapSchema(),
      Marquee: createMarqueeSchema(),
      MenuBar: createMenuBarSchema(),
      ProgressBar: createProgressBarSchema(),
      RadioGroup: createRadioGroupSchema(),
      Rating: createRatingSchema(),
      ...
      TabPane: createTabPaneSchema(),
      TabPaneItem: createTabPaneItemSchema(),
  ...
  <head>
    ...
    <style>
      :root {
        ...
        --pc-semantic-focus-ring-success: 0 0 0 3px rgba(22, 163, 74, 0.25);
        --pc-semantic-focus-ring-warning: 0 0 0 3px rgba(202, 138, 4, 0.25);
        --pc-semantic-focus-ring-danger: 0 0 0 3px rgba(220, 38, 38, 0.25);
...
${bodyHtml}      </div>
    ...
    props: {
      ...
      minWidth: {
        ...
        cssVariableName: "--page-min-width",
        defaultValue: "auto",
        label: "Minimum width",
        role: "layout",
        roleGroup: "Size",
      ...
      maxWidth: {
        ...
        cssVariableName: "--page-max-width",
        defaultValue: "none",
        label: "Maximum width",
        role: "layout",
        roleGroup: "Size",
      ...
      minHeight: {
        ...
        cssVariableName: "--page-min-height",
        defaultValue: "auto",
      ...
      maxHeight: {
        ...
        cssVariableName: "--page-max-height",
        defaultValue: "none",
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Canvas", "Card", "Dialog", "Divider", "Element", "Footer", "Form", "Grid", "Map", "Marquee", "MenuBar", "ProgressBar", "Rating", "RichText", "Section", "SideBar", "Spacer", "Spinner", "TabPane", "Table"],
      },
    },
  };
}
