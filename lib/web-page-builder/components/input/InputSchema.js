...
`;
      ...
      .input.input-warning:focus-visible {
        border-color: var(--pc-semantic-status-warning);
      ...
      .input.input-danger:read-only {
        border-color: var(--pc-semantic-status-danger);
        box-shadow: none;
        outline: none;
      }

      .input.input-success:read-only {
        border-color: var(--pc-semantic-status-success);
        box-shadow: none;
        outline: none;
      }

      .input.input-warning:read-only {
        border-color: var(--pc-semantic-status-warning);
        box-shadow: none;
        outline: none;
      }
`;
    ...
    exportHTML: (input, inputSchema, pageSchema, indentation) => {
      ...
      return `${indentation}<input class="input ${input?.id}${input?.props?.theme === "danger" ? " input-danger" : input?.props?.theme === "success" ? " input-success" : input?.props?.theme === "warning" ? " input-warning" : ""}"${disabled ? ` disabled="disabled"` : ""} data-pc-id="${input?.id || ""}"${input?.props?.id ? ` id="${input.props.id}"` : ""}${name ? ` name="${name}"` : ""} placeholder="${input?.props?.placeholder || ""}"${readOnly ? ` readonly="readonly"` : ""}${typeof spellCheck === "boolean" ? ` spellcheck="${spellCheck}"` : ""} type="${type}" value="${input?.props?.value || ""}" />`;
    },
