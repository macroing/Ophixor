...
function EditorSlotWrapper({ children, component, parentId, slotId, slotName, slotOwnerType }) {
  ...
  const onDragOver = useCallback(
    ...
    [editorStore, isDraggingOverAllowed, slotId],
  );
  ...
  const onDrop = useCallback(
    ...
    [componentId, editorStore, isDraggingOverAllowed, parentId, slotId, slotName],
  );
  ...
  }, [editorStore, editorStore.context.dragState, slotName, slotOwnerType]);
  ...
  const object = useMemo(
    ...
    [editorStore, editorStore.context.dragState, isDraggingOver, isDraggingOverAllowed, isNear, onDragEnd, onDragEnter, onDragLeave, onDragOver, onDrop, slotId],
  );
