        ...
        slots: {
          ...
          body: [
            <div key="1" style={{ display: "grid", gap: "1rem" }}>
              ...
              <DarkInput isDebounceDisabled={true} onChange={onChangeLabel} placeholder={platform.websiteAdmin.pages.editor.componentTemplateSaveDialog.labelPlaceholder[language]} value={label} />
              <DarkLabel text={platform.websiteAdmin.pages.editor.componentTemplateSaveDialog.typeTitle[language]} />
              <DarkInput isDebounceDisabled={true} onChange={onChangeType} placeholder={platform.websiteAdmin.pages.editor.componentTemplateSaveDialog.typePlaceholder[language]} readOnly={true} value={type} />
              <DarkLabel text={platform.websiteAdmin.pages.editor.componentTemplateSaveDialog.descriptionTitle[language]} />
              <DarkInput isDebounceDisabled={true} onChange={onChangeDescription} placeholder={platform.websiteAdmin.pages.editor.componentTemplateSaveDialog.descriptionPlaceholder[language]} value={description} />
            </div>,
          ],
          footer: [
