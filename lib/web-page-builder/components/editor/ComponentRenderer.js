...
const ComponentInstanceRenderer = memo(({ component, componentSchema, index, isEmpty = false, parentId, props, slotIndex, slotName }) => {
  ...
  if (requiredConsent && !hasConsent(requiredConsent)) {
    return (
      <ComponentWrapper component={component} index={index} parentId={parentId} slotIndex={slotIndex} slotName={slotName}>
...
export default function ComponentRenderer({ component, index, isDataSourceTurnedOff = false, isEmpty = false, parentId, resolvedProps, slotIndex, slotName }) {
  ...
  if (component.dataSource?.type === "integration" && !isDataSourceTurnedOff) {
    return <IntegrationRenderer component={component} componentSchema={componentSchema} index={index} parentId={parentId} parentModel={parentModel} props={props} slotIndex={slotIndex} slotName={slotName} />;
  }

  if (component.dataSource && !isDataSourceTurnedOff) {
    return <DataSourceRenderer component={component} componentSchema={componentSchema} index={index} parentId={parentId} props={props} slotIndex={slotIndex} slotName={slotName} />;
  }

  return <ComponentInstanceRenderer component={component} componentSchema={componentSchema} index={index} isEmpty={isEmpty} parentId={parentId} props={props} slotIndex={slotIndex} slotName={slotName} />;
}

const DataSourceItemRenderer = memo(({ component, componentSchema, index, isDataSourceTurnedOff, isEmpty, parentId, props, scope, slotIndex, slotName }) => {
  ...
  return (
    <DataModelProvider value={scope}>
      <ComponentRenderer component={component} index={index} isDataSourceTurnedOff={isDataSourceTurnedOff} isEmpty={isEmpty} parentId={parentId} resolvedProps={reactiveProps} slotIndex={slotIndex} slotName={slotName} />
    </DataModelProvider>
  );
});

function DataSourceRenderer({ component, componentSchema, index, parentId, props, slotIndex, slotName }) {
  const parentModel = useDataModel();
  ...
  if (Array.isArray(reactiveScope)) {
    if (reactiveScope.length === 0) {
      return <DataSourceItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={true} parentId={parentId} props={props} scope={EMPTY_OBJECT} slotIndex={slotIndex} slotName={slotName} />;
    }

    return reactiveScope.map((item, itemIndex) => <DataSourceItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={false} key={component.id + "-" + itemIndex} parentId={parentId} props={props} scope={item} slotIndex={slotIndex} slotName={slotName} />);
  }

  if (reactiveScope !== null && typeof reactiveScope !== "object") {
    return <DataSourceItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={false} parentId={parentId} props={props} scope={reactiveScope} slotIndex={slotIndex} slotName={slotName} />;
  }
  ...
  return <DataSourceItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={isEmpty} parentId={parentId} props={props} scope={scope} slotIndex={slotIndex} slotName={slotName} />;
}

const IntegrationItemRenderer = memo(({ component, componentSchema, index, isDataSourceTurnedOff, isEmpty, parentId, props, scope, slotIndex, slotName }) => {
  const { rendererEngine } = useWebPageBuilderRenderer();
...
function IntegrationRenderer({ component, componentSchema, index, isMountedRef, parentId, parentModel, props, slotIndex, slotName }) {
  ...
  if (Array.isArray(data)) {
    if (data.length === 0) {
      return <IntegrationItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={true} isMountedRef={isMountedRef} parentId={parentId} props={props} scope={EMPTY_OBJECT} slotIndex={slotIndex} slotName={slotName} />;
    }

    return data.map((item, itemIndex) => <IntegrationItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={false} isMountedRef={isMountedRef} key={component.id + "-" + itemIndex} parentId={parentId} props={props} scope={item} slotIndex={slotIndex} slotName={slotName} />);
  }
  ...
  return <IntegrationItemRenderer component={component} componentSchema={componentSchema} index={index} isDataSourceTurnedOff={true} isEmpty={isEmpty} isMountedRef={isMountedRef} parentId={parentId} props={props} scope={scope} slotIndex={slotIndex} slotName={slotName} />;
}
...
function renderSlots(component) {
  ...
  if (slotEntries.length === 1) {
    ...
    return {
      children: (slotComponents || []).map((slotComponent, slotComponentIndex) => {
        if (Array.isArray(slotComponent)) {
          return slotComponent.map((currentSlotComponent, currentSlotComponentIndex) => <ComponentRenderer component={currentSlotComponent} index={currentSlotComponentIndex} isEmpty={slotComponent.length === 0} key={currentSlotComponent.id + "-" + currentSlotComponentIndex} parentId={component.id} slotIndex={currentSlotComponentIndex} slotName={slotName} />);
        }

        return <ComponentRenderer component={slotComponent} index={slotComponentIndex} isEmpty={(slotComponents || []).length === 0} key={slotComponent.id} parentId={component.id} slotIndex={null} slotName={slotName} />;
      }),
    };
  }
  ...
  for (const [slotName, slotComponents] of slotEntries) {
    namedSlots[slotName] = (slotComponents || []).map((slotComponent, slotComponentIndex) => <ComponentRenderer component={slotComponent} index={slotComponentIndex} isEmpty={(slotComponents || []).length === 0} key={slotComponent.id} parentId={component.id} slotIndex={null} slotName={slotName} />);
  }
