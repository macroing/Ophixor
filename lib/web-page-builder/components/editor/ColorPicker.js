  ...
  return (
    <label className={styles.wrapper}>
      <div className={styles.control}>
        <DarkInput disabled={disabled} isDebounceDisabled={false} onChange={onChangeColorInput} title={platform.websiteAdmin.pages.editor.selectColor[language]} type="color" value={extractHex(inputValue) || "#000000"} />
        <DarkInput disabled={disabled} isDebounceDisabled={false} onChange={onChangeTextInput} placeholder={placeholder} spellCheck={false} type="text" value={inputValue} />
