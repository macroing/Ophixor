...
function EditorComponentWrapper({ children, component, index, parentId, slotName }) {
  ...
  const onDragStart = useCallback(
    ...
    [componentId, index, parentId, slotName, type],
  );
  ...
  const onDrop = useCallback(
    ...
    [componentId, isDraggingOverAllowed, schema],
  );
  ...
  const object = useMemo(
    ...
    [componentId, draggable, isDraggingOver, isDraggingOverAllowed, isSelected, isNear, onClick, onContextMenu, onDragEnd, onDragEnter, onDragLeave, onDragOver, onDragStart, onDrop, onMouseDown, slot],
  );
