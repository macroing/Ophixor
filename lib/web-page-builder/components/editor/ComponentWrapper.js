...
function EditorComponentWrapper({ children, component, index, parentId, slotName }) {
  ...
  const isSelected = componentId === editorStore.context.selectedId;
  ...
  const onDrop = useCallback(
    ...
    [componentId, editorStore, isDraggingOverAllowed, schema],
  );
  ...
  }, [editorStore, editorStore.context.dragState, schema]);
  ...
  const object = useMemo(
    () => ({
      editor: {
        ...
        isNearDropTarget: editorStore.context.isShowingContentOnly ? undefined : !!editorStore.context.dragState && editorStore.context.activeDropZoneRef.current !== componentId && isNear(dropZoneContainerRef, pointerRef.current),
        isSelected: editorStore.context.isShowingContentOnly ? undefined : isSelected,
    ...
    [componentId, draggable, editorStore, editorStore.context.dragState, isDraggingOver, isDraggingOverAllowed, isSelected, isNear, onClick, onContextMenu, onDragEnd, onDragEnter, onDragLeave, onDragOver, onDragStart, onDrop, onMouseDown, slot],
  );
