...
export default function Icon(props) {
  ...
  const hasPointer = props.hasPointer;
  ...
  return <FontAwesomeIcon className={styles.icon + (customClassName ? " " + customClassName : "") + (hasPointer ? " " + styles.icon_pointer : "") + (isResponsive ? " " + styles.icon_responsive : "") + (onClick ? " " + styles.icon_clickable : "") + (theme === "danger" ? " " + styles.icon_danger : "")} icon={icon} onClick={onClick} style={{ ...(style || {}), fontSize: isResponsive ? fontSize : undefined, height: isResponsive ? undefined : size + "px", maxHeight: isResponsive ? undefined : size + "px", maxWidth: isResponsive ? undefined : size + "px", minHeight: isResponsive ? undefined : sizeMin + "px", minWidth: isResponsive ? undefined : sizeMin + "px", width: isResponsive ? undefined : size + "px" }} />;
}
