...
${section?.slots?.body || ""}${(section?.slots?.body || "").trim() === "" ? "\n" : ""}${indentation}</${section?.props?.element || "div"}>`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Alert", "Badge", "Button", "Canvas", "Card", "Checkbox", "Dialog", "Divider", "Element", "Form", "Grid", "Heading", "Image", "Input", "Label", "Link", "List", "Map", "MenuBar", "RichText", "RadioGroup", "Section", "Select", "Spacer", "Spinner", "Switch", "Table", "Text", "TextArea"],
      },
    },
  };
}
