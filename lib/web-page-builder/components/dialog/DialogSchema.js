...
`;
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Button", "Divider", "Element", "Grid", "Heading", "Icon", "Image", "List", "Marquee", "ProgressBar", "Rating", "Section", "Spacer", "Spinner", "TabPane", "Table", "Text"],
      },
      footer: {
        allowedChildComponents: ["Badge", "Button", "Element", "Icon", "Spacer", "Spinner"],
      },
      header: {
        allowedChildComponents: ["Badge", "Element", "Heading", "Icon", "Image", "Spacer", "Spinner"],
      },
    },
  };
}
