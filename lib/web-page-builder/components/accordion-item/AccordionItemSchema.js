...
export function createAccordionItemSchema() {
  return {
    ...
    slots: {
      body: {
        allowedChildComponents: ["Accordion", "Button", "Divider", "Grid", "Element", "Form", "Heading", "Icon", "Image", "Link", "List", "Marquee", "ProgressBar", "Rating", "RichText", "Section", "Spacer", "Spinner", "TabPane", "Table", "Text"],
      },
    },
  };
}
