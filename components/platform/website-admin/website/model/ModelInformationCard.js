    ...
    <>
            ...
            body: [
              <Section alignItems="flex-start" flexDirection="column" gap="1.25rem" justifyContent="flex-start" key="content" padding="0px">
                <Section alignItems="center" flexDirection="row" justifyContent="space-between" padding="0px">
                  ...
                  <Badge {...createBadgeProps("active")} borderRadius="6px" fontSize="0.7rem" fontWeight="500" padding="0.25rem 0.6rem" text={"Active"} />
                </Section>
                <Section flexDirection="column" gap="0.5rem" padding="0px">
                  ...
                  <Text color="#64748b" fontSize="0.75rem" text={`Last updated ${formatRelativeTime(websiteModel.updatedAt)}`} />
                </Section>
                <Section alignItems="center" flexDirection="row" justifyContent="space-between" padding="0px">
                  <Link backgroundColorHover="rgba(37, 99, 235, 0.08)" borderRadius="6px" color="#2563eb" colorHover="#1d4ed8" fontSize="0.85rem" href={(isCustomDomain ? "/admin" : "/website-admin/" + website.code) + "/models/" + websiteModel._id.toString()} padding="0.35rem 0.6rem" text="Open" />
                  {canDelete && <Button backgroundColor="transparent" backgroundColorHover="rgba(220, 38, 38, 0.08)" borderColor="transparent" borderColorHover="transparent" borderRadius="6px" boxShadow="none" boxShadowHover="none" color="#dc2626" colorHover="#991b1b" fontSize="0.85rem" onClick={(e) => setIsDialogVisible(true)} padding="0.35rem 0.6rem" text="Delete" transformHover="none" />}
                </Section>
              </Section>,
            ],
            footer: [],
      ...
      {isDialogVisible && (
        <Dialog dialogRef={dialogRef}>
          {{
            slots: {
              header: [<Heading color="#0f172a" key="1" level="6" text="Delete Model" />],
              body: [<Text key="1" text="Are you sure you want to delete the model?" />],
              footer: [
